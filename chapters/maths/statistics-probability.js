...
const QS={sp1:[
  ...
  {id:'sp2q1',level:'cbse',diff:1,text:'P(not A) if P(A)=0.4:',opts:['0.6','0.4','1','0'],correct:0,concept:'sp2',exp:{short:'Complement rule.',steps:['P(not A)=1-P(A)=1-0.4=0.6'],answer:'0.6.'}},
