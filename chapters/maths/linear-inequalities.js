...
const NUMS=[
  ...
  {level:'advanced',concept:'li2',title:'Numerical 7 — LP Optimization',problem:'Maximize Z=5x+3y subject to: x+y≤6, x≥0, y≥0, 3x+y≤12.',opts:['20','21','18','24'],correct:3,steps:['Find corner points of feasible region','(0,0): Z=0','(4,0): Z=20','(3,3): Z=15+9=24','(0,6): Z=18','Maximum Z=24 at (3,3)'],answer:'Z_max=24 at (3,3).'},
  {level:'advanced',concept:'li1',title:'Numerical 8 — Inequality System',problem:'Solve: x²−1<0 AND |x|<2.',opts:['−1<x<1','−2<x<2','x∈(−1,1)∩(−2,2)','same as −1<x<1'],correct:3,steps:['x²−1<0 ⇒ (x-1)(x+1)<0 ⇒ −1<x<1','|x|<2 ⇒ −2<x<2','Intersection = −1<x<1'],answer:'−1<x<1.'}
];
const QB=[
